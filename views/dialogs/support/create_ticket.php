...
use Concrete\Package\SidebarTheme\Controller\Dialog\Support\CreateTicket;
...
<form action="<?php echo (string)Url::to("/ccm/system/dialogs/sidebar_theme/create_ticket/submit"); ?>"
      data-dialog-form="create-ticket"
      method="post"
      enctype="multipart/form-data">

    <?php echo $form->hidden('projectHandle', "sidebar_theme"); ?>
